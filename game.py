...
class Game:
    ...
    def __init__(self, screen, messages_to_send, our_team, who_gets_to_be_red_number):
        ...
        # To quickly test piece placement, override these two settings.
        # self.game_state = STATE_OUR_TURN
